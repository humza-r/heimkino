...
window.CONFIG = {
  ...
  endpoint: "https://script.google.com/macros/s/AKfycbzOzhiugVHdb_sCFxhMyVw6lRGGR9t854t7I-z9jtiPFJFsxTIO8UN-5k7FXWAQma2g/exec",            // paste your Apps Script /exec URL here, in quotes
  ...
  /* ---- PAST (Heimkino nights only) ----
     attendees: ["…"]  the hold-to-reveal names (PUBLIC in this file, a courtesy
                       screen, not real privacy). The number is the reveal target.
     attendance: 3     shows a count only and keeps names off the site.
     Entries are numbered and sorted by date automatically, so order here does
     not matter. Films watched outside the club are not listed here. */
  past: [
    {
      date: "2026-08-11",
      title: "Kingdom of Heaven", director: "Ridley Scott", year: 2005,
      attendees: ["Fynn, Senthuran, Mina, Stav, Milana"],
