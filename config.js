...
window.CONFIG = {
  ...
  next: {
   ...
   hostNote: "A long one tonight, three hours and fifteen for Ridleys special directors cut. House drink: Dr. Pepper Float.",  // a personal line for THIS screening only; set to "" to hide it
