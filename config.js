  ...
  past: [
    {
     ...
     { date: "2026-08-02", title: "Following",  attendees: ["Soedeh"], director: "Christopher Nolan", year: 1979, private: true },
    {
      date: "2026-07-30",
      title: "Salò, or the 120 Days of Sodom", director: "Pier Paolo Pasolini", year: 1975,
      attendees: ["Senthuran", "Stav", "Fynn"],
      // factual logline; replace with your preferred synopsis if you like.
      synopsis: "In the final days of Fascist Italy, four powerful men confine a grou p of young people at a villa and subject them to systematic cruelty."
    }
  ]
};
